...
def images_to_pdf(image_paths, output_path):
    ...
    PyMuPDF (fitz) orqali ishlaydi — har bir rasm bittadan ochilib, sahifa
    sifatida qo'shilib, darhol yopiladi. Pillow'ning save_all usulidan farqli
    o'laroq, BARCHA rasmlarni bir vaqtning o'zida RAM'da saqlamaydi — bu katta
    (masalan manga-style, 20-30+ sahifali) PDF'larda xotira tugab qolishining
    (va shu sababli "Yakuniy PDF yaratilmoqda" bosqichida qotib qolishning)
    oldini oladi.
    """
    import io
    doc = fitz.open()
